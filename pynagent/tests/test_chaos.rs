//! Chaos Tests - Stress testing Pynagent's resilience
//!
//! These tests run Pynagent against pathological Python inputs to verify:
...
fn test_chaos_all_files_parse_without_panic() {
    ...
    for test_file in &test_files {
        ...
        let result = std::panic::catch_unwind(|| {
            ...
            let tree = Pynagent_rs::scanner::tree_sitter::parse(&content)
