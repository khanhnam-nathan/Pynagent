...
This document tracks the implementation status of Pynagent's Rust accelerator (`Pynagent-rs`).
...
Pynagent Rust is **15x faster than Semgrep** and **200x faster than Bandit** on real-world vulnerable codebases.
