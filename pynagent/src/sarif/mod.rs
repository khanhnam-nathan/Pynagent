//! Pynagent Rust SARIF 2.1.0 Export Module
//!
...
/// Convert Pynagent severity to SARIF level.
...
/// Convert Pynagent severity to CVSS score string.
...
mod tests {
    ...
    fn test_sarif_report() {
        ...
        let tool = SarifTool::new("Pynagent", "3.0.0", "https://github.com/Pynagent/Pynagent", vec![]);
        ...
        assert_eq!(json["runs"][0]["tool"]["driver"]["name"], "Pynagent");
    }
}
