...
pub fn create_sarif_report(
    ...
    let mut builder = SarifBuilder::new(tool_name, tool_version, "https://github.com/Pynagent/Pynagent");
...
mod tests {
    ...
    fn test_sarif_builder_basic() {
        let builder = SarifBuilder::new("Pynagent", "3.0.0", "https://github.com/Pynagent/Pynagent");
        let report = builder.build();

        assert_eq!(report.version, "2.1.0");
        assert_eq!(report.runs[0].tool.driver.name, "Pynagent");
    }
