...
impl GitLabVulnerability {
    pub fn new(rule_id: &str, severity: &str, _message: &str) -> Self {
        Self {
            ...
            scanner: GitLabScanner::new("Pynagent", env!("CARGO_PKG_VERSION")),
            links: vec![],
            metadata: None,
            flags: vec![],
            ident: None,
...
impl GitLabScanner {
    pub fn new(name: &str, version: &str) -> Self {
        Self {
            ...
            external_id: Some(format!("Pynagent://{}", name.to_lowercase())),
        }
    }
}
...
/// Convert Pynagent findings to GitLab SAST format.
