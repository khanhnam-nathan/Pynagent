...
# Import from site-packages (Rust extension), not local Pynagent_rs
local_path = str(Path(__file__).parent.parent / "Pynagent_rs")
if local_path in sys.path:
    sys.path.remove(local_path)

from Pynagent_rs import scan, SecurityScanner
...
def test_file_scanning():
    ...
    security_file = Path(__file__).parent.parent / "Pynagent" / "rules" / "security.py"
