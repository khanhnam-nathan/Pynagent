"""Interactive TUI for Pynagent - Terminal User Interface for security scanning.
...
from Pynagent.core.types import SecurityFinding, SecuritySeverity, RuleConfig
from Pynagent.rules.security import SecurityScannerRule
from Pynagent.rules.secrets import SecretsScannerRule
from Pynagent.rules.iac_security import TerraformSecurityRule, KubernetesSecurityRule, DockerSecurityRule
...
class InteractiveScanner:
    """Interactive TUI scanner for Pynagent."""
