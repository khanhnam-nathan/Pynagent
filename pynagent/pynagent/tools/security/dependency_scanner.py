...
from Pynagent.core.types import DependencyFinding, SecuritySeverity
...
class DependencyScanner:
    ...
    def cve_db(self):
        ...
        if self._cve_db is None:
            from Pynagent.tools.security.advisory_db import CVEDatabase
    ...
    def gh_advisory_db(self):
        ...
        if self._gh_advisory_db is None:
            from Pynagent.tools.security.advisory_db import GitHubAdvisoryDB
