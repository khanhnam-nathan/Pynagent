"""Secrets scanning rules for Pynagent - detects hardcoded API keys, tokens, and credentials.
...
from Pynagent.rules.security_registry import register_security_rule
