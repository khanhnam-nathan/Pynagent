"""Plugin loader for Pynagent plugins."""
...
from Pynagent.plugins.base import Plugin

logger = logging.getLogger(__name__)


class PluginLoader:
    """Loads and manages Pynagent plugins via entry points."""

    ENTRY_POINT_GROUP = "Pynagent.plugins"
    ...
    def load_from_path(self, path: Path) -> Plugin:
        ...
        spec = importlib.util.spec_from_file_location("Pynagent_plugin", path)
