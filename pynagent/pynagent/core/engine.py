...
from Pynagent.core.atomic import AtomicWriter
from Pynagent.core.semantic_guard import SemanticDiffGuard
from Pynagent.core.type_shield import TypeAwareShield
...
class LlmAnalyzerClient:
    ...
    without requiring the Pynagent-rs Rust extension.
    """
    ...
    def _find_api_key(self) -> Optional[str]:
        for var in ("Pynagent_LLM_API_KEY", "OPENAI_API_KEY", "ANTHROPIC_API_KEY"):
            ...
            for encoding in encodings:
                try:
                    with open(file_path, 'r', encoding=encoding) as f:
                        raw = f.read()
                    # Strip BOM  Pynagent always writes UTF-8 without BOM
                    BOM = "\ufeff"
